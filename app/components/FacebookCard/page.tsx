...
const FacebookCard = () => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl p-6 text-center shadow-md border-t-2 border-blue-600 hover:bg-slate-700 hover:cursor-pointer">
            <div className="text-gray-400 text-sm mb-2">
                <div className="flex justify-center gap-2 mb-5">
                    <img src="images/icon-facebook.svg" className="w-[20px] h-[20px]" alt="Youtube Icon" />
            ...
            <h2 className="text-4xl font-bold text-white">{facebookStats?.followers}</h2>
