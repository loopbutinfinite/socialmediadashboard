...
const TwitterCard = () => {
    ...
    return (
        <div className="bg-slate-800 card rounded-xl p-6 text-center shadow-md border-t-2 border-blue-400 hover:bg-slate-700 hover:cursor-pointer">
            <div className="text-gray-400 text-sm mb-2">
                <div className="flex justify-center gap-2 mb-5">
                    <img src="images/icon-twitter.svg" className="w-[20px] h-[20px]" alt="Twitter Icon" />
                    <div className="font-bold">
                        {twitterStats?.username}
                    </div>
                </div>
            </div>
            <h2 className="text-5xl font-bold">{twitterStats?.followers}</h2>
